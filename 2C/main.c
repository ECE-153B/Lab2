...
void RTC_Set_Alarm(void) {
	...
	RTC->ALRMBR |= RTC_ALRMBR_MSK4;		// Set Mask 4 to make date a dont-care	
	RTC->ALRMBR |= RTC_ALRMBR_MSK3;		// Set Mask 3 to make date a dont-care
	RTC->ALRMBR |= RTC_ALRMBR_MSK2;		// Set Mask 2 to make date a dont-care	
	RTC->ALRMBR |= RTC_ALRMBR_MSK1;		// Set Mask 1 to make date a dont-care	
