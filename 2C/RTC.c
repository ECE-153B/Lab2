...
void RTC_Init(void) {
	...
	RTC_Set_Calendar_Date(RTC_WEEKDAY_WEDNESDAY, 25, RTC_MONTH_JANUARY, 23); /* [TODO] These values are stubs - fill in current date */
	
	// Configure the Time 
	RTC_Set_Time(RTC_TR_PM, 1, 0, 0); /* [TODO] These values are stubs - fill in current time */
